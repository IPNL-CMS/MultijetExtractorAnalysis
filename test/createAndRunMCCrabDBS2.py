...
datasets = [
    ...
    #["/QCD_HT-100To250_TuneZ2star_8TeV-madgraph-pythia/apequegn-QCD_HT-100To250_START53_V7A_13Mar14-v1-c5f9c59e100f883a59cec8d8908af608/USER", "QCD_HT-100To250"],
    #["/QCD_HT-250To500_TuneZ2star_8TeV-madgraph-pythia6/apequegn-QCD_HT-250To500_START53_V7A_13Mar14-v1-c5f9c59e100f883a59cec8d8908af608/USER", "QCD_HT-250To500"],
...
def processDataset(dataset):
  ...
  if options.create_cfg:
    ...
    os.system("sed -e \"s#@datasetname@#%s#\" -e \"s#@uiworkingdir@#%s#g\" -e \"s#@email@#%s#g\" -e \"s#@pset@#%s#g\" -e \"s#@outputdir@#%s#\" crab_MC.cfg.DBS2.template.ipnl > %s" % (dataset_path, ui_working_dir, email, python_config, output_dir, output_file))
